...
testruns = testruns.intersection(set(['C','F90','Fortran','C_Complex','Fortran_Complex','C_NoComplex','Fortran_NoComplex','C_NotSingle','VECCUDA','VECCUDA_Complex','VECCUDA_NoComplex']))
