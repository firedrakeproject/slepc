...
class Lapack(package.Package):
  ...
  def Check(self,conf,vars,cmake,petsc):
    ...
    l = ['laev2','gehrd','lanhs','lange','getri','trexc','trevc','geevx','gees','ggev','ggevx','gelqf','geqp3','gesdd','tgexc','tgevc','pbtrf','stedc','hsein','larfg','larf','trsen','tgsen','lacpy','lascl','lansy','laset']
