...
class Sowing(package.Package):
  ...
  def __init__(self,argdb,log):
    ...
    self.version      = '1.1.26'
    self.url          = 'https://bitbucket.org/petsc/pkg-sowing/get/v'+self.version+'-p2.tar.gz'
    self.archive      = 'sowing-'+self.version+'-p2.tar.gz'
    self.dirname      = 'sowing-'+self.version+'-p2'
