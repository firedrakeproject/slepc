...
#undef __FUNCT__
#define __FUNCT__ "MatMult_QLinear_N1A"
PetscErrorCode MatMult_QLinear_N1A(Mat A,Vec x,Vec y)
{
  PetscErrorCode    ierr;
  QEP_LINEAR        *ctx;
...
#undef __FUNCT__
#define __FUNCT__ "MatMult_QLinear_N1B"
PetscErrorCode MatMult_QLinear_N1B(Mat B,Vec x,Vec y)
{
  PetscErrorCode    ierr;
  QEP_LINEAR        *ctx;
  const PetscScalar *px;
...
#undef __FUNCT__
#define __FUNCT__ "MatGetDiagonal_QLinear_N1A"
PetscErrorCode MatGetDiagonal_QLinear_N1A(Mat A,Vec diag)
{
  PetscErrorCode ierr;
  QEP_LINEAR     *ctx;
  PetscScalar    *pd;
...
#undef __FUNCT__
#define __FUNCT__ "MatGetDiagonal_QLinear_N1B"
PetscErrorCode MatGetDiagonal_QLinear_N1B(Mat B,Vec diag)
{
  PetscErrorCode ierr;
  QEP_LINEAR     *ctx;
  PetscScalar    *pd;
...
#undef __FUNCT__
#define __FUNCT__ "MatCreateExplicit_QLinear_N1A"
PetscErrorCode MatCreateExplicit_QLinear_N1A(MPI_Comm comm,QEP_LINEAR *ctx,Mat *A)
{
  PetscErrorCode ierr;
  PetscInt       M,N,m,n;
  Mat            Id;
...
#undef __FUNCT__
#define __FUNCT__ "MatCreateExplicit_QLinear_N1B"
PetscErrorCode MatCreateExplicit_QLinear_N1B(MPI_Comm comm,QEP_LINEAR *ctx,Mat *B)
{
  PetscErrorCode ierr;
  PetscInt       M,N,m,n;
  Mat            Id;
