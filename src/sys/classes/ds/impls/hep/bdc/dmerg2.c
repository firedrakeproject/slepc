...
/*  ===================================================================== */
  ...
  *info = 0;
  ...
  PetscCheckFalse(*info,PETSC_COMM_SELF,PETSC_ERR_ARG_WRONG,"Wrong argument %" PetscBLASInt_FMT " in DMERG2",-(*info));
...
/* **************************************************************************** */
  ...
  *(unsigned char *)defl = '0';
  ...
  ierr = BDC_dsrtdf_(&k, n, n1, ev, q, ldq, indxq, rho, &work[iz],
          ...
          CHKERRQ(ierr);
  PetscCheckFalse(*info,PETSC_COMM_SELF,PETSC_ERR_LIB,"dmerg2: error in dsrtdf, info = %" PetscBLASInt_FMT,*info);
...
/* **************************************************************************** */
  ...
  if (k != 0) {
    ...
    PetscCheckFalse(spneed > lwork,PETSC_COMM_SELF,PETSC_ERR_MEM,"dmerg2: Workspace needed exceeds the workspace provided by %" PetscBLASInt_FMT " numbers",spneed-lwork);
    ...
    PetscCheckFalse(*info,PETSC_COMM_SELF,PETSC_ERR_LIB,"dmerg2: error in dlaed3m, info = %" PetscBLASInt_FMT,*info);
