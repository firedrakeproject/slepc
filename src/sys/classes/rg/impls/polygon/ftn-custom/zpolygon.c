...
SLEPC_EXTERN void PETSC_STDCALL rgpolygongetvertices_(RG *rg,PetscInt *n,PetscScalar *vr,PetscScalar *vi,int *ierr)
{
  PetscScalar *ovr,*ovi;
  PetscInt    n_;
...
SLEPC_EXTERN void PETSC_STDCALL rgpolygongetvertices0_(RG *rg,PetscInt *n,PetscScalar *vr,PetscScalar *vi,int *ierr)
{
  rgpolygongetvertices_(rg,n,vr,vi,ierr);
}

SLEPC_EXTERN void PETSC_STDCALL rgpolygongetvertices1_(RG *rg,PetscInt *n,PetscScalar *vr,PetscScalar *vi,int *ierr)
{
  rgpolygongetvertices_(rg,n,vr,vi,ierr);
}
