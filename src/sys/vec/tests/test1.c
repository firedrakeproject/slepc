...
int main(int argc,char **argv)
{
  ...
  PetscCheckFalse(size > 2,PETSC_COMM_WORLD,PETSC_ERR_WRONG_MPI_SIZE,"This test needs one or two processes");
  ...
  PetscCheckFalse(k!=8,PETSC_COMM_WORLD,PETSC_ERR_PLIB,"Vector global length should be 8");
  ...
  PetscCheckFalse(n!=2,PETSC_COMM_WORLD,PETSC_ERR_PLIB,"n should be 2");
  for (i=0;i<2;i++) {
  ...
  PetscCheckFalse(PetscAbsReal(norm-normc)>10*PETSC_MACHINE_EPSILON,PETSC_COMM_WORLD,PETSC_ERR_PLIB,"Norms are different");
  ...
  PetscCheckFalse(PetscAbsScalar(dot[0]-dotc[0])>10*PETSC_MACHINE_EPSILON,PETSC_COMM_WORLD,PETSC_ERR_PLIB,"Dots are different");
  ...
  PetscCheckFalse(PetscAbsScalar(dot[0]-dotc[0])>10*PETSC_MACHINE_EPSILON || PetscAbsScalar(dot[1]-dotc[1])>10*PETSC_MACHINE_EPSILON,PETSC_COMM_WORLD,PETSC_ERR_PLIB,"Dots are different");
  vecs[0] = w; vecs[1] = y;
  ...
  PetscCheckFalse(PetscAbsScalar(dot[0]-dotc[0])>10*PETSC_MACHINE_EPSILON,PETSC_COMM_WORLD,PETSC_ERR_PLIB,"Dots are different");
  PetscCheckFalse(PetscAbsReal(norm-normc)>100*PETSC_MACHINE_EPSILON,PETSC_COMM_WORLD,PETSC_ERR_PLIB,"Norms are different");
  ...
  PetscCheckFalse(PetscAbsReal(norm12[0]-norm12c[0])>10*PETSC_MACHINE_EPSILON || PetscAbsReal(norm12[1]-norm12c[1])>10*PETSC_MACHINE_EPSILON,PETSC_COMM_WORLD,PETSC_ERR_PLIB,"Norms are different");
