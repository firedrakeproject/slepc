...
PetscErrorCode EPSView(EPS eps,PetscViewer viewer)
{
  ...
  ierr = PetscObjectTypeCompareAny((PetscObject)eps,&isexternal,EPSARPACK,EPSBLOPEX,EPSBLZPACK,EPSELEMENTAL,EPSFEAST,EPSPRIMME,EPSSCALAPACK,EPSTRLAN,"");CHKERRQ(ierr);
  if (!isexternal) {
