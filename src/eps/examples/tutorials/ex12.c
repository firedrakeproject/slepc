...
int main(int argc,char **argv)
{
  ...
  KSP            ksp;
  PC             pc;
  PetscInt       N,n=35,m,Istart,Iend,II,nev,i,j;
  PetscBool      flag;
  PetscReal      int0,int1;
  PetscErrorCode ierr;
  ...
  if (!flag) m=n;
  N = n*m;
  ierr = PetscPrintf(PETSC_COMM_WORLD,"\nSymmetric-definite problem with interval, N=%D (%Dx%D grid)\n\n",N,n,m);CHKERRQ(ierr);
  ...
  */
  ...
  /*
     Set interval and other settings
  */
  ierr = EPSSetWhichEigenpairs(eps,EPS_ALL);CHKERRQ(ierr);
  ierr = EPSSetInterval(eps,1,1.3);CHKERRQ(ierr);
