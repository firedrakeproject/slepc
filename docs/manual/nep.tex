...
The \ident{NEP} module of SLEPc has been explained with more detail in \citep{Campos:2019:NEP}, including an algorithmic description of the implemented solvers.
