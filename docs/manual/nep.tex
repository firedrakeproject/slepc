...
The \texttt{NEPRII} and \texttt{NEPNARNOLDI} solvers need a \ident{KSP} object to handle the solution of linear systems of equations. This \ident{KSP} is present in all \ident{NEP} instances, and can be retrieved with
	\findex{NEPGetKSP}
	\begin{Verbatim}[fontsize=\small]
