...
\item \ident{FN}: Mathematical Function. As described in chapter \ref{cap:nep}, it is required in application code to represent the constituent functions of the nonlinear operator in split form.
