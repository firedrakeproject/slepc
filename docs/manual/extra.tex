...
\item An arc region similar to an ellipse but consisting of a thin stripe along the ellipse with an optional start and end angles, see \ident{RGArcSetParameters}).
\end{itemize}
