...
\item An arc region similar to an ellipse but consisting of a thin stripe along the ellipse with optional start and end angles, see \ident{RGArcSetParameters}.
\end{itemize}
...
Arc                    & \texttt{RGARC}      & \texttt{arc} \\\hline
\end{tabular} }
