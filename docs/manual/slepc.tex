...
\item Modified chapter \ref{cap:pep} to cover polynomial eigenvalue problems instead of just quadratic eigenvalue problems.
\end{itemize}
...
\begin{quote}
\begin{sffamily}
Copyright 2002--2014 Universidad Polit\'ecnica de Valencia, Spain
\end{sffamily}
\end{quote}
