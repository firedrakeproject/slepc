...
In this version, the following parts of the Users Manual have been added or modified with respect to the previous one:
\begin{itemize}
\setlength{\itemsep}{-2pt}
\item Chapter \ref{cap:qep} is new, and describes the solvers for quadratic eigenproblems.
\item A new section \ref{sec:precond} describes the new functionality associated to preconditioned solvers.
\item Parts of chapter \ref{cap:eps} have been updated to include new \texttt{EPS} features, e.g., \S\ref{sec:defprob} and \S\ref{sec:retrsol}.
\end{itemize}
