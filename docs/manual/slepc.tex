...
\author{
{\small\sffamily Developers:}\hspace*{4cm}\\
  Carmen Campos\\
  Jos\'e E. Rom\'an\\
  Eloy Romero\\
  Andr\'es Tom\'as\\[3mm]
{\small\sffamily Former collaborators:}\hspace*{2.7cm}\\
  Vicente Hern\'andez\\
  Vicent Vidal\\[1cm]
}
...
\item A new subsection \ref{sec:slice} describes the new functionality related to the computation of all eigenvalues in a given interval.
\item Two new sections have been added to chapter \ref{cap:add}, describing ongoing work to support GPU computing \S\ref{sec:gpu} and the Matlab interface \S\ref{sec:matlab}.
\end{itemize}
...
\begin{quote}
\begin{sffamily}
Copyright 2002--2010 Universidad Polit\'ecnica de Valencia, Spain
\end{sffamily}
\end{quote}
