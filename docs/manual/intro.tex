...
\begin{enumerate}
	...
	\begin{Verbatim}[fontsize=\small]
	export SLEPC_DIR=/home/username/slepc-3.1
	\end{Verbatim}
	...
	\begin{Verbatim}[fontsize=\small]
	export PETSC_DIR=/home/username/petsc-3.1
	export PETSC_ARCH=darwin10.4.0-c-debug
	\end{Verbatim}
...
In order to prepare a prefix-based installation of \slepc that uses a prefix-based installation of \petsc, start by setting the appropriate value of \ident{PETSC\_DIR}. Then, run \slepc's configure with a prefix directory.
	\begin{Verbatim}[fontsize=\small]
	export PETSC_DIR=/opt/petsc-3.1-linux-gnu-c-debug
	export PETSC_ARCH=linux-gnu-c-debug
	cd $SLEPC_DIR
	./configure --prefix=/opt/slepc-3.1-linux-gnu-c-debug
	make 
	make install
	unset PETSC_ARCH
	export SLEPC_DIR=/opt/slepc-3.1-linux-gnu-c-debug
	\end{Verbatim}
...
\ident{SLEPC\_DIR}, indicating the full path of the directory containing \slepc. For example, under the \texttt{bash} shell, a command of the form
	\begin{Verbatim}[fontsize=\small]
	export SLEPC_DIR=/software/slepc-3.1
	\end{Verbatim}
