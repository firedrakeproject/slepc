...
\begin{tikzpicture}[xscale=0.7,yscale=0.8] 
  ...
  \draw[interface] (11,4*\levsep+\himp) rectangle node {Polynomial Eigensolver} +(4.2,\hint);
  \draw[implem] (11,4*\levsep) rectangle node[text width=1.2cm] {TOAR} ++(1.2,1) ++(0,-1) 
                rectangle node[text width=1.7cm] {Q-Arnoldi} ++(1.6,1) ++(0,-1)
                rectangle node[text width=1.7cm] {Linear\-ization} ++(1.4,1);

  \draw[interface] (15.5,4*\levsep+\himp) rectangle node {Nonlinear Eigensolver} +(3.7,\hint);
  \draw[implem] (15.5,4*\levsep) rectangle node {SLP} ++(1.1,1) ++(0,-1) 
                rectangle node {RII} ++(1.1,1) ++(0,-1)
                rectangle node[text width=1.7cm] {N-Arnoldi} ++(1.5,1);
  ...
  \draw[interface] (11,\hint) rectangle node {BV} +(2.5,1.0);
  \draw[interface] (13.85,\hint) rectangle node {DS} +(2.5,1.0);
  \draw[interface] (16.7,\hint) rectangle node {FN} +(2.5,1.0);
\end{tikzpicture}
