...
\footnotetext{If \slepc is compiled for real numbers (\Verb!BOPT=O!), then the absolute value of the imaginary part,$|\mathrm{Im}(\lambda)|$, is used for eigenvalue selection and sorting.}
