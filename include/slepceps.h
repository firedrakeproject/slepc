...
PETSC_EXTERN PetscErrorCode EPSKrylovSchurSetPartitions(EPS,PetscInt,PetscBool);
PETSC_EXTERN PetscErrorCode EPSKrylovSchurGetPartitions(EPS,PetscInt*,PetscBool*);
