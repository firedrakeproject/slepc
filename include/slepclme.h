...
PETSC_EXTERN PetscErrorCode LMESetRHS(LME,BV,BV);
PETSC_EXTERN PetscErrorCode LMEGetRHS(LME,BV*,BV*);
PETSC_EXTERN PetscErrorCode LMESetSolution(LME,BV,BV);
PETSC_EXTERN PetscErrorCode LMEGetSolution(LME,BV*,BV*);
